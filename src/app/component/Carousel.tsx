      ...
      >
        {blogPosts.map((post) => (
          <SwiperSlide key={post.id}>
            <div
              className="w-full h-[500px] bg-cover bg-center rounded-2xl flex flex-col justify-end text-white p-6"
      ...
      >
        {products.map((p) => (
          <SwiperSlide key={p.id}>
            <div className="h-full w-full rounded-2xl p-6 flex flex-col justify-center items-center text-white font-semibold bg-gradient-to-r from-pink-500 to-purple-600 shadow-md">
